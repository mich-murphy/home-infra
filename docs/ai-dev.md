...
broker's nine read tools (six media reads and three qBittorrent torrent reads)
and its three gated write tools; the broker itself
...
verify the broker's nine read and three gated write tools.
